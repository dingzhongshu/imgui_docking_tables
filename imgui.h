...
struct ImFontAtlas
{
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesArabic();                 // Default + Arabic characters
    IMGUI_API const ImWchar*    GetGlyphRangesLatin();                  // Default + Latin extended characters
...
IMGUI_API struct FinnoGlobalVar
{
